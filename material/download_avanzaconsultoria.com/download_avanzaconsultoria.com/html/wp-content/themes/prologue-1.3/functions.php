...
function prologue_recent_projects_widget( $args ) {
	...
	$title = empty( $options['title'] ) ? __( 'Tags recientes' ) : $options['title'];
...
<p><a class="allrss" href="<?php bloginfo( 'rss2_url' ); ?>">RSS de todas las novedades</a></p>
...
<p><label for="prologue_title"><?php _e('Título:') ?> 
<input type="text" class="widefat" id="prologue_title" name="prologue_title" value="<?php echo $title ?>" />
</label></p>

<p><label for="prologue_num_to_show"><?php _e('Num de tags a mostrar:') ?> 
<input type="text" class="widefat" id="prologue_num_to_show" name="prologue_num_to_show" value="<?php echo $num_to_show ?>" />
</label></p>

<?php
}
wp_register_sidebar_widget( 'prologue_recent_projects_widget', __( 'Proyectos recientes' ), 'prologue_recent_projects_widget' );
wp_register_widget_control( 'prologue_recent_projects_widget', __( 'Proyectos recientes' ), 'prologue_recent_projects_control' );
