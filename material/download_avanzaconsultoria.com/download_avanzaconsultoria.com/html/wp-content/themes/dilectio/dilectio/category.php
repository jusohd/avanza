...
<h3><a title="Link permanente <?php the_title(); ?>" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h3>
<small class="PostAuthor">Por: <?php the_author() ?> on: <?php the_time('M j,Y') ?></small>
...
<div class="PostCom">
<ul>
 <li class="Com"><?php comments_popup_link('0 Commentarios', '1 Commentario', '% Commentarios'); ?></li>
