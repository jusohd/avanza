...
<h2 class="pagetitle">Archivo del &#8216;<strong><?php single_cat_title(); ?></strong>&#8217; Category</h2>
...
<h3><a title="Link Permanente a <?php the_title(); ?>" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h3>
<small class="Author">Por: <?php the_author() ?> on: <?php the_time('M j,Y') ?></small>
...
<h2 class="pagetitle">No se encuentra</h2>
<?php endif; ?>
