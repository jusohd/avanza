  ...
  <div id="content">
	...
	<?php if (have_posts()) : ?>
		<?php while (have_posts()) : the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
			  <h2><a href="<?php the_permalink() ?>" rel="bookmark" title="Enlace permanente a <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
				<div class="postmeta">
				Escrito por <?php the_author() ?> el <?php the_time('j F Y') ?>, archivado en <?php the_category(', ') ?><?php edit_post_link('Editar', ', ', ''); ?>
				</div>
				<div class="entry">
		...
		<a href="#"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/ads468x60.jpg" title="Anúnciate aquí" alt="Anúnciate aquí" /></a>
			...
			<div class="previous-entries"><?php previous_post_link('&laquo; %link') ?></div>
			<div class="next-entries"><?php next_post_link('%link &raquo;') ?></div>
			<hr class="clear"/>
			</div>
