...
function breadcrumb_nav_xt_install()
{
	...
	if(get_option(breadcrumb_nav_version) != $bcn_version)
	{
		...
		update_option('breadcrumb_nav_title_blog', 'Home');
		...
		update_option('breadcrumb_nav_singleblogpost_prefix', '');
		...
		update_option('breadcrumb_nav_archive_category_prefix', '');
		...
		update_option('breadcrumb_nav_link_current_item', 'true');
