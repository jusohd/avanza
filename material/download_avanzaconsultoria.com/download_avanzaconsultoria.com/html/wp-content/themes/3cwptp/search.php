...
<div class="post_info"><?php the_excerpt(','); ?><p><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>">lee el resto de &quot;<?php the_title(); ?>&quot;</a></p></div>
