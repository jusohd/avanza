...
$options = array (
    ...
    array(	"name" => "Twitter",
			"desc" => "Enter your twitter account url here. Leave it blank if you don't use Twitter",
			"id" => "twitter",
			"std" => "#",
			"type" => "text"),
	...
	switch ( $value['type'] ) {
       ...
       <tr>
		...
		?>
            <tr>
            <td width="20%" rowspan="2" valign="middle"><strong><?php echo $value['name']; ?></strong></td>
                <td width="80%"><? if(get_theme_option($value['id'])){ $checked = "checked=\"checked\""; }else{ $checked = ""; } ?>
