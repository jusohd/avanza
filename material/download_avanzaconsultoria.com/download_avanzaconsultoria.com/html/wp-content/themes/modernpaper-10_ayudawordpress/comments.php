<?php // Do not delete these lines
	...
	if (!empty($post->post_password)) { // if there's a password
		if ($_COOKIE['wp-postpass_' . COOKIEHASH] != $post->post_password) {  // and it doesn't match the cookie
			...
			<p class="nocomments">Este post esta protegido por contraseña. Introducir la contraseña para ver los comentarios.<p>
...
<div id="commentblock">
<?php if ($comments) : ?>
	<p id="comments"><b><?php comments_number('Ninguna respuesta', 'Una respuesta', '% Respuestas' );?> para &#8220;<?php the_title(); ?>&#8221;</b></p>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<em>Comentario en espera de ser moderado</em>
			<?php endif; ?>
...
<p id="respond"><b>No hay mas respuestas</b></p>

<?php if ( get_option('comment_registration') && !$user_ID ) : ?>
<p>debes estar <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>">Registrado para</a> realizar un comentario</p>
<?php else : ?>
...
<p><label for="email">Direccion de email <?php if ($req) echo "(requerido)"; ?></label><br />
...
<!--<p><small><strong>XHTML:</strong> Usted puede usar estas etiquetas: <?php echo allowed_tags(); ?></small></p>-->
