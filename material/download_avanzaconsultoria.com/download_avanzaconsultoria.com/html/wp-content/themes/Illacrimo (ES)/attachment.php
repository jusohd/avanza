...
<div class="PostHead">
<h1><a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment"><?php echo get_the_title($post->post_parent); ?></a></h1> <h3><a href="<?php echo get_permalink() ?>" rel="bookmark" title="Enlace permanente a: <?php the_title(); ?>"><?php the_title(); ?></a></h3>
</div>
<div class="PostContent">
<p><?php echo $attachment_link; ?><br /><br /><?php echo basename($post->guid); ?></p>
<?php the_content('<p class="serif">Leer la entrada completa &raquo;</p>'); ?>
<?php wp_link_pages(array('before' => '<p><strong>Paginas:</strong> ', 'after' => '</p>', 'next_or_number' => 'number')); ?>
</div>
</div>

<?php endwhile; else: ?>
<p>Lo siento, no se ha encontrado lo que buscaba.</p>
