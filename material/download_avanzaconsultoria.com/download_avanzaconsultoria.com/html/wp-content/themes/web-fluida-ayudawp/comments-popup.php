...
<head>
     <title><?php echo get_settings('blogname'); ?> - Comentarios en <?php the_title(); ?></title>
...
<p><a href="<?php echo get_settings('siteurl'); ?>/wp-commentsrss2.php?p=<?php echo $post->ID; ?>"><abbr title="Really Simple Syndication">RSS</abbr> Suscribirse a los comentarios de este post.</a></p>

<?php if ('open' == $post->ping_status) { ?>
<p>La <acronym title="Uniform Resource Identifier">URI</acronym> para enviar un Trackback a esta entrada es: <em><?php trackback_url() ?></em></p>
<?php } ?>
...
<?php foreach ($comments as $comment) { ?>
	...
	<?php comment_text() ?>
	<p><cite><?php comment_type('Comentario', 'Trackback', 'Pingback'); ?> de <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite></p>
	</li>
...
<p>La linea y parrafo se cortan automaticamente, el email nunca se muestra, <acronym title="Hypertext Markup Language">HTML</acronym> permitido: <code><?php echo allowed_tags(); ?></code></p>
...
<p>Lo siento, en este momento no se pueden hacer comentarios.</p>
<?php }
} // end password check
?>
